...
export default class Particles {
  ...
  initPoints (discard) {
    ...
    if (discard) {
      ...
      // console.log(Float32Array.from(imgData.data) / 2);
      originalColors = Float32Array.from(imgData.data);
      // console.log(Float32Array.from(imgData.data));
      // console.log(Float32Array.from(imgData.data).slice(0, 20000));
  ...
  show (time = 1.0) {
    ...
    TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time * 1.5, { value: 75.0 }, { value: 4.0 });
